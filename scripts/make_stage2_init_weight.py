...
parser.add_argument("--cldm_config", type=str, default="configs/modelcfg/refsr_simu.yaml")
parser.add_argument("--sd_weight", type=str, default="data/checkpoints/v2-1_512-ema-pruned.ckpt")
parser.add_argument("--swinir_weight", type=str, default="data/checkpoints/general_swinir_v1.ckpt")
parser.add_argument("--output", type=str, default="data/checkpoints/init_weight/init_weight-refsr-w-encoder.pt")

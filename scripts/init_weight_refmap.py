...
parser.add_argument("--cldm_config", type=str, default="configs/modelcfg/refmap_level_wc.yaml")
parser.add_argument("--sd_weight", type=str, default="data/checkpoints/v2-1_512-ema-pruned.ckpt")
parser.add_argument("--output", type=str, default="data/checkpoints/init_weight/init_weight-refmap-o-cascade.pt")
